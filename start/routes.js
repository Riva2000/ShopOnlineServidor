...
Route.group(()=>{
    ...
    Route.delete('departamento/:id','UserController.deleteDepartamento')
    ...
    Route.get('consulta','UserController.indexdv')
    Route.post('detalle_venta','UserController.insertDetalle_Venta')
    Route.delete('detalle_venta/:id','UserController.deleteDetalle_venta')
